const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HtmlSandbox-ChKMbqOK.js","assets/index-BF7V7Q45.js","assets/monaco-editor-CGO6wXTd.js","assets/monaco-editor-C4Ekkcmw.css","assets/index-5paILcei.css","assets/MonacoEditor-DW460wiE.js","assets/MonacoEditor-Ds3ou6sA.css","assets/MarkdownPreview-DTg4OOGo.js","assets/markdown-BK1wOLk7.js","assets/MarkdownPreview-D6ouO8gz.css","assets/PythonRunner-Xc8FhX46.js","assets/PhpRunner-BHJR6KS3.js","assets/SqliteRunner-C-gX4cb8.js","assets/JavaRunner-doIB-HNb.js","assets/RubyRunner-C6LD5zWm.js","assets/PerlRunner-DgpJD6jm.js"])))=>i.map(i=>d[i]);
import{_ as d}from"./monaco-editor-CGO6wXTd.js";import{u as U,r as k,k as W,o as $,l as J,c as o,g as L,d as t,t as g,e as i,F as C,f as j,m as u,p as r,S as c,h as V,q as M,n as S,j as l,i as Y,b as m,s as p}from"./index-BF7V7Q45.js";const Z={key:0,class:"mb-6 text-center"},G={class:"text-3xl font-black text-slate-900 dark:text-white tracking-tight"},K={class:"mt-2 text-slate-500 font-medium"},Q={class:"flex justify-start gap-2 mb-4 overflow-x-auto whitespace-nowrap pb-2 md:pb-0 scrollbar-hide px-1"},X=["onClick"],ee={key:0,class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},te={key:1,class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},le={key:2,class:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24"},se={key:3,class:"w-4 h-4",viewBox:"0 0 24 24",fill:"currentColor"},oe={key:4,class:"w-4 h-4",viewBox:"0 0 24 24",fill:"currentColor"},re={key:5,class:"w-4 h-4",viewBox:"0 0 24 24",fill:"currentColor"},ae={key:6,class:"w-4 h-4",viewBox:"0 0 24 24",fill:"currentColor"},ne={key:7,class:"w-4 h-4",viewBox:"0 0 24 24",fill:"currentColor"},ie={key:8,class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},de=["title"],ue={key:0,class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},ce={key:1,class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},me={class:"flex-1 bg-slate-800 rounded-2xl overflow-hidden border border-slate-700 shadow-2xl min-h-0"},pe={key:8,class:"flex flex-col h-full"},ve={class:"flex items-center gap-6 px-4 py-3 border-b border-slate-700 bg-slate-800/50"},fe={class:"flex items-center gap-3"},be={class:"text-sm text-slate-400 font-medium"},he=["value"],ge={class:"flex items-center gap-3"},xe=["value"],ye={class:"flex-1 min-h-0"},Le={__name:"index",setup(ke){const{t:n}=U(),R=p(()=>d(()=>import("./HtmlSandbox-ChKMbqOK.js"),__vite__mapDeps([0,1,2,3,4,5,6]))),I=p(()=>d(()=>import("./MarkdownPreview-DTg4OOGo.js"),__vite__mapDeps([7,8,2,3,5,1,4,6,9]))),T=p(()=>d(()=>import("./PythonRunner-Xc8FhX46.js"),__vite__mapDeps([10,1,2,3,4,5,6]))),z=p(()=>d(()=>import("./PhpRunner-BHJR6KS3.js"),__vite__mapDeps([11,2,3,1,4,5,6]))),A=p(()=>d(()=>import("./SqliteRunner-C-gX4cb8.js"),__vite__mapDeps([12,1,2,3,4,5,6]))),P=p(()=>d(()=>import("./JavaRunner-doIB-HNb.js"),__vite__mapDeps([13,1,2,3,4,5,6]))),D=p(()=>d(()=>import("./RubyRunner-C6LD5zWm.js"),__vite__mapDeps([14,1,2,3,4,5,6]))),B=p(()=>d(()=>import("./PerlRunner-DgpJD6jm.js"),__vite__mapDeps([15,1,2,3,4,5,6]))),H=p(()=>d(()=>import("./MonacoEditor-DW460wiE.js"),__vite__mapDeps([5,2,3,1,4,6]))),a=k("sandbox"),h=k(!1),q=()=>{h.value=!h.value},O=W(()=>[{id:"sandbox",icon:"web",label:n("tools.code-playground.modes.sandbox")},{id:"markdown",icon:"markdown",label:n("tools.code-playground.modes.markdown")},{id:"python",icon:"python",label:n("tools.code-playground.modes.python")},{id:"php",icon:"php",label:n("tools.code-playground.modes.php")},{id:"java",icon:"java",label:n("tools.code-playground.modes.java")},{id:"ruby",icon:"ruby",label:n("tools.code-playground.modes.ruby")},{id:"perl",icon:"perl",label:n("tools.code-playground.modes.perl")},{id:"sqlite",icon:"sqlite",label:n("tools.code-playground.modes.sqlite")},{id:"editor",icon:"code",label:n("tools.code-playground.modes.editor")}]),v=k("javascript"),w=k(`// Write your code here
function greet(name) {
  return \`Hello, \${name}!\`;
}
