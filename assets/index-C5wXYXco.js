const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HtmlSandbox-Bol__YYo.js","assets/index-EXevfkqS.js","assets/monaco-editor-CIrctJzJ.js","assets/monaco-editor-Ys5nfKlh.css","assets/index-DkQ3O_3V.css","assets/MonacoEditor-w0Cn9MOS.js","assets/MonacoEditor-Ds3ou6sA.css","assets/MarkdownPreview-Nkx_ftSB.js","assets/markdown-C78r6xLZ.js","assets/MarkdownPreview-D6ouO8gz.css","assets/PythonRunner-H1P74hzS.js","assets/PhpRunner-BDcxHVtV.js","assets/SqliteRunner-D0KZtniv.js"])))=>i.map(i=>d[i]);
import{_ as p}from"./monaco-editor-CIrctJzJ.js";import{u as N,r as y,k as O,o as z,l as U,c as s,g as C,d as t,t as v,e as i,F as E,f as V,m as f,p as a,S as h,h as S,q as M,n as I,j as l,i as W,b,s as g}from"./index-EXevfkqS.js";const J={key:0,class:"mb-6 text-center"},Y={class:"text-3xl font-black text-slate-900 dark:text-white tracking-tight"},G={class:"mt-2 text-slate-500 font-medium"},$={class:"flex justify-center gap-2 mb-4"},K=["onClick"],Q={key:0,class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},X={key:1,class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},Z={key:2,class:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24"},ee={key:3,class:"w-4 h-4",viewBox:"0 0 24 24",fill:"currentColor"},te={key:4,class:"w-4 h-4",viewBox:"0 0 24 24",fill:"currentColor"},le={key:5,class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},oe=["title"],se={key:0,class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},ae={key:1,class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},ne={class:"flex-1 bg-slate-800 rounded-2xl overflow-hidden border border-slate-700 shadow-2xl min-h-0"},re={key:5,class:"flex flex-col h-full"},ie={class:"flex items-center gap-6 px-4 py-3 border-b border-slate-700 bg-slate-800/50"},de={class:"flex items-center gap-3"},ue={class:"text-sm text-slate-400 font-medium"},ce=["value"],me={class:"flex items-center gap-3"},pe=["value"],ve={class:"flex-1 min-h-0"},ge={__name:"index",setup(fe){const{t:r}=N(),T=g(()=>p(()=>import("./HtmlSandbox-Bol__YYo.js"),__vite__mapDeps([0,1,2,3,4,5,6]))),A=g(()=>p(()=>import("./MarkdownPreview-Nkx_ftSB.js"),__vite__mapDeps([7,8,2,3,5,1,4,6,9]))),D=g(()=>p(()=>import("./PythonRunner-H1P74hzS.js"),__vite__mapDeps([10,5,2,3,1,4,6]))),P=g(()=>p(()=>import("./PhpRunner-BDcxHVtV.js"),__vite__mapDeps([11,2,3,5,1,4,6]))),q=g(()=>p(()=>import("./SqliteRunner-D0KZtniv.js"),__vite__mapDeps([12,5,2,3,1,4,6]))),B=g(()=>p(()=>import("./MonacoEditor-w0Cn9MOS.js"),__vite__mapDeps([5,2,3,1,4,6]))),n=y("sandbox"),m=y(!1),L=()=>{m.value=!m.value},R=O(()=>[{id:"sandbox",icon:"web",label:r("tools.code-playground.modes.sandbox")},{id:"markdown",icon:"markdown",label:r("tools.code-playground.modes.markdown")},{id:"python",icon:"python",label:r("tools.code-playground.modes.python")},{id:"php",icon:"php",label:r("tools.code-playground.modes.php")},{id:"sqlite",icon:"sqlite",label:r("tools.code-playground.modes.sqlite")},{id:"editor",icon:"code",label:r("tools.code-playground.modes.editor")}]),d=y("javascript"),w=y(`// Write your code here
function greet(name) {
  return \`Hello, \${name}!\`;
}
