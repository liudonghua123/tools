import{_ as ye,u as ge,r as D,E as he,k as pt,l as be,o as ve,a as _e,c as h,b as we,d as s,t as f,e as _,n as M,F as L,f as j,g as F,i as dt,j as b,B as Se}from"./index-fwKDu2KB.js";import{_ as E,e as Ae}from"./monaco-editor-CGO6wXTd.js";import ke from"./katex-Cu_Erd72.js";var De=Object.defineProperty,l=(t,e)=>De(t,"name",{value:e,configurable:!0}),bt=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,a)=>(typeof require<"u"?require:e)[a]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')}),Fe=(()=>{for(var t=new Uint8Array(128),e=0;e<64;e++)t[e<26?e+65:e<52?e+71:e<62?e-4:e*4-205]=e;return a=>{for(var i=a.length,r=new Uint8Array((i-(a[i-1]=="=")-(a[i-2]=="="))*3/4|0),n=0,o=0;n<i;){var p=t[a.charCodeAt(n++)],c=t[a.charCodeAt(n++)],m=t[a.charCodeAt(n++)],u=t[a.charCodeAt(n++)];r[o++]=p<<2|c>>4,r[o++]=c<<4|m>>2,r[o++]=m<<6|u}return r}})();function vt(t){return!isNaN(parseFloat(t))&&isFinite(t)}l(vt,"_isNumber");function C(t){return t.charAt(0).toUpperCase()+t.substring(1)}l(C,"_capitalize");function K(t){return function(){return this[t]}}l(K,"_getter");var I=["isConstructor","isEval","isNative","isToplevel"],O=["columnNumber","lineNumber"],R=["fileName","functionName","source"],Pe=["args"],Ee=["evalOrigin"],X=I.concat(O,R,Pe,Ee);function S(t){if(t)for(var e=0;e<X.length;e++)t[X[e]]!==void 0&&this["set"+C(X[e])](t[X[e]])}l(S,"StackFrame");S.prototype={getArgs:l(function(){return this.args},"getArgs"),setArgs:l(function(t){if(Object.prototype.toString.call(t)!=="[object Array]")throw new TypeError("Args must be an Array");this.args=t},"setArgs"),getEvalOrigin:l(function(){return this.evalOrigin},"getEvalOrigin"),setEvalOrigin:l(function(t){if(t instanceof S)this.evalOrigin=t;else if(t instanceof Object)this.evalOrigin=new S(t);else throw new TypeError("Eval Origin must be an Object or StackFrame")},"setEvalOrigin"),toString:l(function(){var t=this.getFileName()||"",e=this.getLineNumber()||"",a=this.getColumnNumber()||"",i=this.getFunctionName()||"";return this.getIsEval()?t?"[eval] ("+t+":"+e+":"+a+")":"[eval]:"+e+":"+a:i?i+" ("+t+":"+e+":"+a+")":t+":"+e+":"+a},"toString")};S.fromString=l(function(t){var e=t.indexOf("("),a=t.lastIndexOf(")"),i=t.substring(0,e),r=t.substring(e+1,a).split(","),n=t.substring(a+1);if(n.indexOf("@")===0)var o=/@(.+?)(?::(\d+))?(?::(\d+))?$/.exec(n,""),p=o[1],c=o[2],m=o[3];return new S({functionName:i,args:r||void 0,fileName:p,lineNumber:c||void 0,columnNumber:m||void 0})},"StackFrame$$fromString");for(T=0;T<I.length;T++)S.prototype["get"+C(I[T])]=K(I[T]),S.prototype["set"+C(I[T])]=(function(t){return function(e){this[t]=!!e}})(I[T]);var T;for(N=0;N<O.length;N++)S.prototype["get"+C(O[N])]=K(O[N]),S.prototype["set"+C(O[N])]=(function(t){return function(e){if(!vt(e))throw new TypeError(t+" must be a Number");this[t]=Number(e)}})(O[N]);var N;for(q=0;q<R.length;q++)S.prototype["get"+C(R[q])]=K(R[q]),S.prototype["set"+C(R[q])]=(function(t){return function(e){this[t]=String(e)}})(R[q]);var q,et=S;function _t(){var t=/^\s*at .*(\S+:\d+|\(native\))/m,e=/^(eval@)?(\[native code])?$/;return{parse:l(function(a){if(a.stack&&a.stack.match(t))return this.parseV8OrIE(a);if(a.stack)return this.parseFFOrSafari(a);throw new Error("Cannot parse given Error object")},"ErrorStackParser$$parse"),extractLocation:l(function(a){if(a.indexOf(":")===-1)return[a];var i=/(.+?)(?::(\d+))?(?::(\d+))?$/,r=i.exec(a.replace(/[()]/g,""));return[r[1],r[2]||void 0,r[3]||void 0]},"ErrorStackParser$$extractLocation"),parseV8OrIE:l(function(a){var i=a.stack.split(`
