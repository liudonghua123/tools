...
disp(eig(A));
`}},h=r("hello"),f=r(v.hello.code);O(h,o=>{v[o]&&(f.value=v[o].code)});const n=r(!1),m=r(!1),p=r(null),w=r("");let l=null,x=null;const y=r(null),A=()=>{l=new H.Terminal({cursorBlink:!0,fontSize:14,fontFamily:'Menlo, Monaco, "Courier New", monospace',theme:{background:"#0f172a",foreground:"#e2e8f0"}}),x=new W.FitAddon,l.loadAddon(x),l.open(y.value),x.fit(),l.write(`\x1B[38;5;244mResult will appear here...\x1B[0m\r
